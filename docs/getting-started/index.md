...
This guide walks you through setting up Quartz from scratch. If you already ran the [[Portfolio/docs/getting-started/index#🪴 Get Started|quickstart]] on the home page, you can skip ahead to whichever step you're on.
